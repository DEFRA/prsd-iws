...
namespace EA.Iws.Web.Areas.NotificationApplication.Views.Importer {
    ...
    public class ImporterResources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to This should be the correspondence address for the importer - consignee. Note that this may be different to the registered company address so ensure you use the appropriate address..
        /// </summary>
