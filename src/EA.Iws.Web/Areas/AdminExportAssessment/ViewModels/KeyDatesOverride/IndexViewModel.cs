namespace EA.Iws.Web.Areas.AdminExportAssessment.ViewModels.KeyDatesOverride
{
    ...
    public class IndexViewModel
    {
        public IndexViewModel()
        {
            ...
            DecisionRequiredByDate = new DateInputViewmodel(allowPastDates: true, showLabels: false);
        ...
        public IndexViewModel(KeyDatesOverrideData data)
        {
            ...
            DecisionRequiredByDate = new DateInputViewmodel(data.DecisionRequiredByDate, allowPastDates: true, showLabels: false);
        ...
        public OptionalDateInputViewModel TransmittedDate { get; set; }
