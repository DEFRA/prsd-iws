namespace EA.Iws.RequestHandlers.Authorization
{
    ...
    public class InMemoryAuthorizationManager : IAuthorizationManager
    {
        private static readonly IDictionary<string, IList<UserRole>> authorizations = new Dictionary<string, IList<UserRole>>
        {
            ...
            { SystemConfigurationPermissions.CanAddNewEntryOrExitPoint, new[] { UserRole.Internal, UserRole.Administrator } },
            { SystemConfigurationPermissions.CanSendTestEmail, new[] { UserRole.Internal, UserRole.Administrator } },
            ...
            { UserAdministrationPermissions.CanApproveNewInternalUser, new[] { UserRole.Internal, UserRole.Administrator } },
