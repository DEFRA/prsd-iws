namespace EA.Iws.RequestHandlers.Authorization
{
    ...
    public class InMemoryAuthorizationManager : IAuthorizationManager
    {
        private static readonly IDictionary<string, IList<UserRole>> authorizations = new Dictionary<string, IList<UserRole>>
        {
            ...
            { ReportingPermissions.CanViewProducerReport, new[] { UserRole.Internal, UserRole.Administrator, UserRole.ReadOnly } },
            { ReportingPermissions.CanViewEADataReport, new[] { UserRole.Internal, UserRole.Administrator, UserRole.ReadOnly } },
            ...
            { ExportNotificationPermissions.CanChangeNumberOfShipmentsOnExportNotification, new[] { UserRole.External, UserRole.Internal, UserRole.Administrator } },
            { ExportNotificationPermissions.CanChangeEntryExitPoint, new[] { UserRole.Administrator } },
            { ExportNotificationPermissions.CanChangeTransitStateEntryExitPoint, new[] { UserRole.Administrator } },
            ...
            { ExportNotificationPermissions.CanExternalUserDeleteNotification, new[] { UserRole.External } },
