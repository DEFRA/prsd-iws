...
AS
	SELECT
		...
		P.RegistrationNumber AS ProducerRegNumber,
		I.Name AS ImporterName,
		I.RegistrationNumber AS ImporterRegNumber,
		E.Name AS ExporterName,
		E.RegistrationNumber AS ExporterRegNumber,
		F.Name AS FacilityName,
		F.RegistrationNumber AS FacilityRegNumber,
		FC.IsInterim,
