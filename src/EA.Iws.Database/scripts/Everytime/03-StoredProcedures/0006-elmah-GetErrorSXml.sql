...
IF OBJECT_ID('[Logging].[ELMAH_GetErrorsXml]') IS NULL
    EXEC('CREATE PROCEDURE [Logging].[ELMAH_GetErrorsXml] AS SET NOCOUNT ON;')
GO

ALTER PROCEDURE [Logging].[ELMAH_GetErrorsXml]
(
