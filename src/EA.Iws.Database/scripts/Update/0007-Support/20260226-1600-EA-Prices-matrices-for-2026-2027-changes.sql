...
INSERT INTO [Lookup].[PricingStructure] (Id, CompetentAuthority, ShipmentQuantityRangeId, ActivityId, Price, PotentialRefund, ValidFrom) 
	VALUES 	 
	 ...
	 ('FF62BF3C-183F-463B-88B5-92C0957309EB', @CompetentAuthority, '87443EEB-31F5-423F-905A-33ABE23F01F6', '8385CAD7-E5F0-4765-A46B-A4C9010901C7', '4271.79', '0.00', @ValidFrom),-- Export Disposal IsInterim 1 Range 1-5
	 ('22BE94CC-4AED-44AA-8B7B-68254DBF1EA2', @CompetentAuthority, '805CC74A-1D68-44B9-ADC3-A4C90107D231', '8385CAD7-E5F0-4765-A46B-A4C9010901C7', '4812.56', '540.78', @ValidFrom),-- Export Disposal IsInterim 1 Range 6-20
	 ('05497C4F-421C-4A3D-A202-A09553B5BCB4', @CompetentAuthority, '85270610-00B0-4C09-A1DB-A4C90107D231', '8385CAD7-E5F0-4765-A46B-A4C9010901C7', '6036.12', '1764.33', @ValidFrom),-- Export Disposal IsInterim 1 Range 21-100
	 ('3774BDD3-3617-4E99-B670-F8831256EAEF', @CompetentAuthority, '42ECE92D-6470-4B42-BA6A-D8E7FE65A402', '8385CAD7-E5F0-4765-A46B-A4C9010901C7', '8732.90', '4461.12', @ValidFrom),-- Export Disposal IsInterim 1 Range 101-300
	 ('7DAF8381-216F-465D-BB17-4F5A33F87AEF', @CompetentAuthority, '8810022E-11D4-4C25-880B-185787F65053', '8385CAD7-E5F0-4765-A46B-A4C9010901C7', '12649.69', '8377.91', @ValidFrom),-- Export Disposal IsInterim 1 Range 301-500
	 ('2EAEBC38-F1BA-449C-9945-C314D8C078EB', @CompetentAuthority, 'AEF5F83D-E5FB-41B2-84D7-A4C90107D231', '8385CAD7-E5F0-4765-A46B-A4C9010901C7', '15834.00', '11562.22', @ValidFrom),-- Export Disposal IsInterim 1 Range 501-1000
