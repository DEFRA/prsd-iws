...
DECLARE @NotificationId UNIQUEIDENTIFIER = 'E0BD06F9-3BB9-493C-9CA4-632B49D254A1';
...
INSERT [Notification].[MeansOfTransport]
	   ([Id],
	    [NotificationId],
		[MeansOfTransport])
VALUES (N'99F40FF7-A3A7-4817-B1DC-E8E9F28489DC',
		@NotificationId,
		N'R;S;R;A;R');
...
VALUES (
	N'137D915D-651F-4C9C-A031-C8F0A98AB509',
	@NotificationId,
	1
)
...
INSERT [Notification].[ProducerCollection]
	   ([Id],
	    [NotificationId])
VALUES (N'FA6BE1C0-FBE2-45C1-911E-4197479A6035',
		@NotificationId)
...
VALUES (NEWID(),
        ...
        N'44-1112223333',
        N'test@exporter.com',
        N'FA6BE1C0-FBE2-45C1-911E-4197479A6035',
        NULL)
...
INSERT [Notification].[CarrierCollection]
	   ([Id],
	    [NotificationId])
VALUES (N'8548D640-F692-4DA8-8CE8-49859E15DE46',
		@NotificationId)
...
VALUES (NEWID(),
        N'Carrier',
        N'8548D640-F692-4DA8-8CE8-49859E15DE46',
        1,
        N'CARRIER12345',
        NULL,
        N'Business House',
