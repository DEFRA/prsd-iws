...
DECLARE @NotificationId UNIQUEIDENTIFIER = '6FFAB0B9-1F9D-4BE1-A11D-26707412FDB6';
...
INSERT [Notification].[MeansOfTransport]
	   ([Id],
	    [NotificationId],
		[MeansOfTransport])
VALUES (N'FC33F586-E97B-4E39-AD6A-41122145B957',
		@NotificationId,
		N'R;S;R;A;R');
...
VALUES (
	N'2730CA24-B1EB-4E8B-AD55-727B3A9D3566',
	@NotificationId,
	1
)
...
INSERT [Notification].[ProducerCollection]
	   ([Id],
	    [NotificationId])
VALUES (N'520AF92F-46DD-4D8F-88FA-4436B5715D2F',
		@NotificationId)
...
VALUES (NEWID(),
        ...
        N'44-1112223333',
        N'test@exporter.com',
        N'520AF92F-46DD-4D8F-88FA-4436B5715D2F',
        NULL)
...
INSERT [Notification].[CarrierCollection]
	   ([Id],
	    [NotificationId])
VALUES (N'A446C1E5-DA6C-4CF5-B7F1-42D011872B71',
		@NotificationId)
...
VALUES (NEWID(),
        N'Carrier',
        N'A446C1E5-DA6C-4CF5-B7F1-42D011872B71',
        1,
        N'CARRIER12345',
        NULL,
        N'Business House',
