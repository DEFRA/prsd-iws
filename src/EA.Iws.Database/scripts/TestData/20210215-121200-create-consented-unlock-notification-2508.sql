...
DECLARE @NotificationId UNIQUEIDENTIFIER = 'ceb03ae8-2792-4dfc-8f87-6b2384f62508';
DECLARE @FacilityCollectionId UNIQUEIDENTIFIER = NEWID();
DECLARE @ProducerCollectionId UNIQUEIDENTIFIER = NEWID();
DECLARE @CarrierCollectionId UNIQUEIDENTIFIER = NEWID();
