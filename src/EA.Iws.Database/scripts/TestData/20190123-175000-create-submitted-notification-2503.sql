...
DECLARE @NotificationId UNIQUEIDENTIFIER = '7C2916D0-6E65-4C78-9827-8A7B124A8E00';
...
INSERT [Notification].[MeansOfTransport]
	   ([Id],
	    [NotificationId],
		[MeansOfTransport])
VALUES (N'4563830D-8ED5-44EA-94A8-C0A5BB417EE9',
		@NotificationId,
		N'R;S;R;A;R');
...
VALUES (
	N'EFBCC2E5-2A57-4C2C-AC85-F2D7BE710014',
	@NotificationId,
	1
)
...
INSERT [Notification].[ProducerCollection]
	   ([Id],
	    [NotificationId])
VALUES (N'422F3A0D-227A-46AC-870A-175A9CEDA595',
		@NotificationId)
...
VALUES (NEWID(),
        ...
        N'44-1112223333',
        N'test@exporter.com',
        N'422F3A0D-227A-46AC-870A-175A9CEDA595',
        NULL)
...
INSERT [Notification].[CarrierCollection]
	   ([Id],
	    [NotificationId])
VALUES (N'3CB4F08C-C18C-4D1E-B566-423B337FA820',
		@NotificationId)
...
VALUES (NEWID(),
        N'Carrier',
        N'3CB4F08C-C18C-4D1E-B566-423B337FA820',
        1,
        N'CARRIER12345',
        NULL,
        N'Business House',
