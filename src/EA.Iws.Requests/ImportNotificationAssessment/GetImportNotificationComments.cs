namespace EA.Iws.Requests.ImportNotificationAssessment
{
    ...
    public class GetImportNotificationComments : IRequest<ImportNotificationCommentsData>
    {
        ...
        public GetImportNotificationComments(Guid notificationId, NotificationShipmentsCommentsType type, DateTime? startDate, DateTime? endDate, int? shipmentNumber)
        {
