namespace EA.Iws.RequestHandlers.Tests.Unit.NotificationMovements.BulkUpload
{
    ...
    public class PrenotificationQuantityPrecisionForCubicMetresAndTonnesRuleTests
    {
        private readonly PrenotificationQuantityPrecisionForCubicMetresAndTonnesRule rule;
        private readonly Guid notificationId;

        public PrenotificationQuantityPrecisionForCubicMetresAndTonnesRuleTests()
        {
            rule = new PrenotificationQuantityPrecisionForCubicMetresAndTonnesRule();
        ...
        private List<PrenotificationMovement> GetTestData(bool matchingUnit, bool exceedPrecision)
        {
            ...
            var quantity = exceedPrecision ? 1.12345m : 1.1234m;
