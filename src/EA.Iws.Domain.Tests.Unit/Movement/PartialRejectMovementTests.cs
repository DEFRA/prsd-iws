namespace EA.Iws.Domain.Tests.Unit.Movement
{
    ...
    public class PartialRejectMovementTests
    {
        ...
        public async Task WasteReceivedDateBeforeActualShipmentDate_Throws()
        {
            ...
            await Assert.ThrowsAsync<InvalidOperationException>(() => partialRejectionFactory.PartailReject(movement.Id, PastDate, rejectionreason, 1, ShipmentQuantityUnits.Tonnes, 10, ShipmentQuantityUnits.Tonnes, Today));
        }
