    ...
    public class NotificationShipmentTests
    {
        ...
        public void LastDateCantBeBeforeFirstDate()
        {
            ...
            Action addShipmentInfo =
                () =>
                    notification.AddShipmentInfo(firstDate, lastDate, 10, 0.0001M,
        ...
        public void NumberOfShipmentsCantBeZero()
        {
            ...
            Action addShipmentDates = () => notification.AddShipmentInfo(firstDate, lastDate, 0, 100, ShipmentQuantityUnits.Kilogram);
        ...
        public void QuantityCantBeZero()
        {
            ...
            Action addShipmentDates = () => notification.AddShipmentInfo(firstDate, lastDate, 1, 0, ShipmentQuantityUnits.Kilogram);
        ...
        public void NumberOfShipmentsCantBeNegative()
        {
            ...
            Action addShipmentDates = () => notification.AddShipmentInfo(firstDate, lastDate, -5, 100, ShipmentQuantityUnits.Kilogram);
        ...
        public void QuantityCantBeNegative()
        {
            ...
            Action addShipmentDates = () => notification.AddShipmentInfo(firstDate, lastDate, 1, -5, ShipmentQuantityUnits.Kilogram);
        ...
        public void NonPreconsentedNotificationDatesCantBeOutside12Months()
        {
            ...
            Action addShipmentDates = () => notification.AddShipmentInfo(firstDate, lastDate, 0, 0, ShipmentQuantityUnits.Kilogram);
        ...
        public void NonPreconsentedNotificationDatesCanBeInside12Months()
        {
            ...
            notification.AddShipmentInfo(firstDate, lastDate, 1, 1, ShipmentQuantityUnits.Kilogram);
        ...
        public void PreconsentedNotificationDatesCantBeOutside36Months()
        {
            ...
            Action addShipmentDates = () => notification.AddShipmentInfo(firstDate, lastDate, 1, 1, ShipmentQuantityUnits.Kilogram);
        ...
        public void QuantityRoundedUpTo4DecimalPlaces()
        {
            ...
            notification.AddShipmentInfo(firstDate, lastDate, 10, 1.23445M,
                ShipmentQuantityUnits.Tonnes);
        ...
        public void QuantityRoundedDownTo4DecimalPlaces()
        {
            ...
            notification.AddShipmentInfo(firstDate, lastDate, 10, 1.23444M,
                ShipmentQuantityUnits.Tonnes);
        ...
        public void FirstDateCantBeDateTimeMinValue()
        {
            ...
            Action updateDates = () => notification.AddShipmentInfo(firstDate, lastDate, 10, 10M, ShipmentQuantityUnits.Kilogram);
