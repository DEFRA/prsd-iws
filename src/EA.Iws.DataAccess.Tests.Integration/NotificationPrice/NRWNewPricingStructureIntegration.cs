namespace EA.Iws.DataAccess.Tests.Integration.NotificationPrice
{
    ...
    public class NRWNewPricingStructureIntegration
    {
        ...
        [InlineData(UKCompetentAuthority.Wales, TradeDirection.Export, (int)NotificationType.Recovery, true, 1, 1537)]
        [InlineData(UKCompetentAuthority.Wales, TradeDirection.Export, (int)NotificationType.Recovery, true, 2, 1537)]
        [InlineData(UKCompetentAuthority.Wales, TradeDirection.Export, (int)NotificationType.Recovery, true, 5, 1537)]
        [InlineData(UKCompetentAuthority.Wales, TradeDirection.Export, (int)NotificationType.Recovery, true, 6, 2862)]
        [InlineData(UKCompetentAuthority.Wales, TradeDirection.Export, (int)NotificationType.Recovery, true, 20, 2862)]
        [InlineData(UKCompetentAuthority.Wales, TradeDirection.Export, (int)NotificationType.Recovery, true, 21, 4314)]
        [InlineData(UKCompetentAuthority.Wales, TradeDirection.Export, (int)NotificationType.Recovery, true, 100, 4314)]
        [InlineData(UKCompetentAuthority.Wales, TradeDirection.Export, (int)NotificationType.Recovery, true, 101, 8395)]
        [InlineData(UKCompetentAuthority.Wales, TradeDirection.Export, (int)NotificationType.Recovery, true, 500, 8395)]
        [InlineData(UKCompetentAuthority.Wales, TradeDirection.Export, (int)NotificationType.Recovery, true, 501, 15243)]
